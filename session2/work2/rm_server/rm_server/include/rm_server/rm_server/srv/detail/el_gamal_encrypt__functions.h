...
#ifndef RM_SERVER__SRV__DETAIL__EL_GAMAL_ENCRYPT__FUNCTIONS_H_
#define RM_SERVER__SRV__DETAIL__EL_GAMAL_ENCRYPT__FUNCTIONS_H_
...
#include "rm_server/msg/rosidl_generator_c__visibility_control.h"

#include "rm_server/srv/detail/el_gamal_encrypt__struct.h"

/// Initialize srv/ElGamalEncrypt message.
/**
...
/// Create srv/ElGamalEncrypt message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rm_server__srv__ElGamalEncrypt_Request__init().
...
/// Destroy srv/ElGamalEncrypt message.
/**
 * It calls
 * rm_server__srv__ElGamalEncrypt_Request__fini()
...
/// Check for srv/ElGamalEncrypt message equality.
/**
...
/// Copy a srv/ElGamalEncrypt message.
/**
...
/// Initialize array of srv/ElGamalEncrypt messages.
/**
...
/// Finalize array of srv/ElGamalEncrypt messages.
/**
 * It calls
 * rm_server__srv__ElGamalEncrypt_Request__fini()
...
/// Create array of srv/ElGamalEncrypt messages.
/**
 * It allocates the memory for the array and calls
 * rm_server__srv__ElGamalEncrypt_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ElGamalEncrypt messages.
/**
 * It calls
 * rm_server__srv__ElGamalEncrypt_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ElGamalEncrypt message array equality.
/**
...
/// Copy an array of srv/ElGamalEncrypt messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rm_server__srv__ElGamalEncrypt_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rm_server
...
/**
 * It calls
 * rm_server__srv__ElGamalEncrypt_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rm_server
...
/**
 * It allocates the memory for the array and calls
 * rm_server__srv__ElGamalEncrypt_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rm_server
...
/**
 * It calls
 * rm_server__srv__ElGamalEncrypt_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RM_SERVER__SRV__DETAIL__EL_GAMAL_ENCRYPT__FUNCTIONS_H_
