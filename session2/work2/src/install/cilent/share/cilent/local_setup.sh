...
: ${AMENT_CURRENT_PREFIX:="/media/zdk/文件/ckyf/version/rm/rm/session2/work2/src/install/cilent"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cilent/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cilent/environment/path.sh"
